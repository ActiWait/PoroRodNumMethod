...
std::complex<double> betta(const std::complex<double> &s) { //(4)
...
std::complex<double> A(const std::complex<double> &s) { //(12)
    return E() * betta(s) / ro_f;
}

std::complex<double> B(const std::complex<double> &s) { //(12)
...
std::complex<double> lambda(int ind, const std::complex<double> &s) { //(11)
    switch (ind) {
    case 1:
...
std::complex<double> d(int ind, const std::complex<double> &s) {       //(13)
    return (E()*pow(lambda(ind, s),2) - (ro - betta(s)*ro_f))/((alpha() - betta(s))*lambda(ind,s));
}

std::complex<double> u_cap(const std::complex<double> &s, const double & x) {  //(8)
...
std::complex<double> p_cap(const std::complex<double> &s, const double & x) { //(9)
